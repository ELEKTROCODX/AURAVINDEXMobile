...
class BookViewModelOld: ViewModel(){
    ...
    private fun fetchBooks(showDuplicates: Boolean = true, showLents: Boolean = true, page: String = "1", limit: String = "100"){
    ...
    fun getFirstFiveFilteredBooks(books: List<Book>, search: String, filter: String = "title"): List<Book> {
